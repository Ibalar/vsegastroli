...
class MainController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Категории для главной страницы с кэшированием
        $categories = Category::getHomeCategories()->map(function ($category) {
            // Добавляем счетчик опубликованных событий
            $category->events_count = $category->events()->published()->count();
            return $category;
        });

        // Убираем дублирование - используем те же кэшированные категории
